# PERSONALIZED
This version of emacs is directly customized and changed using the Steve Purcell's  emacs.d configuration.

This version is not going to get updates any further. This is just to store data statically.
...
# Connect with the owner of omps emacs.
[omps.in](http://www.omps.in)

[my musings](http://blog.omps.in)

[@ohgnis](https://twitter.com/ohgnis)
# dotemacs
